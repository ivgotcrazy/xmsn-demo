...
/**
 * 01A 厂商注册详情页（原型明确化 §1）：注册表单（手机号/邮箱 + 验证码 + 密码）。
 * 注册校验通过 → 进入企业基本信息（/vendor/register/company）→ 01B 自动登录。
 */
import { ref } from "vue"
...
async function submit(): Promise<void> {
  ...
  try {
    ...
    message.success("注册成功，请完善企业信息")
    await router.push("/vendor/register/company")
  } catch (e) {
...
<template>
  <div class="auth-page">
    <div class="auth-card">
      <h1 class="auth-card__title">厂商注册</h1>
      <p class="auth-card__subtitle">注册后完善企业基本信息</p>
